...
prov_id_num = client.prov_get_id_from_name("Provider 1")
mem_id_num = client.mem_get_id_from_name("Jordan Dexter")
...
client.mem_set_status_from_id(mem_id_num, "SUSPENDED")
client.mem_set_status_from_id(client.mem_get_id_from_name("Nick Lastname"), "SUSPENDED")